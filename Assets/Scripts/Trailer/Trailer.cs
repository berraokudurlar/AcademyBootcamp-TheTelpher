...
public class Trailer : MonoBehaviour
{
    ...
    IEnumerator RunEvent(int id)
    {
        ...
        switch (id)
        {
                ...
                case 2: yield return RunDialogue("???", "Anyway, I am putting all this extra effort in to show how much I like you, you know!"); break;
                case 3: yield return RunDialogue("???", "..."); break;
                case 4: yield return RunDialogue("???", "Don't worry. It's fine."); break;
                ...
                case 9: yield return RunDialogue("???", "Truthfully, I am scared to do many things. Way more simpler things."); break;
                ...
                case 19: yield return RunDialogue("???", "...If you think visual novels are games, that is..."); break;
                case 20: yield return RunDialogue("???", "And it is meaningless to have a main menu that changes according to the time of the day."); break;
                case 21: yield return RunDialogue("???", "And yet, here we are."); break;
                case 22: yield return RunDialogue("???", "Here you are."); break;
                case 23: yield return RunDialogue("???", "This mundane life, devoid of any significance..."); break;
                case 24: yield return RunDialogue("???", "...Might not be so bad, when I am with you, Nora."); break;
                case 25: yield return RunDialogue("???", "That's why... I hope I can become the person you can say this to."); break;
                case 26: yield return RunDialogue("???", "So, let’s just get into it."); break;
